...
// Load the repo-root .env (where the OPENAI/GEMINI/PERPLEXITY keys live),
...
// ── System prompt ─────────────────────────────────────────────────────────────
// TODO: dataContext used to carry live numbers pulled from Neo4j (stats,
// market analytics, predictions, sentiment, network). That data source is
// gone — the blocks below stay empty until a new database is wired up and
// the caller starts passing dataContext again.
...
// TODO: this route was previously behind authMiddleware (auth.js, deleted along
// with the Neo4j user store) and personalized the prompt with the caller's own
// business via getApprovedBusiness. Re-add auth + personalization once the new
// database and its auth model exist.
